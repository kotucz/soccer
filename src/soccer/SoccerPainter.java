...
//		g.fillRect(1, 1, width-2, height-2);
        ...
        g.drawString("" + team1.getScore(), 320 + team1.getSideSign() * 100, 40);
        g.drawString("" + team1.getName(), 240 + team1.getSideSign() * 200, 40);

        g.setColor(team2.getTeamColor());
        g.drawString("" + team2.getScore(), 320 + team2.getSideSign() * 100, 40);
        g.drawString("" + team2.getName(), 240 + team2.getSideSign() * 200, 40);
